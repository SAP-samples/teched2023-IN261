...
var QueueConsumer = function (queueName) {
    ...
    // Establishes connection to Advanced Event Mesh
    ...
    // Starts consuming from a queue on Advanced Event Mesh
    consumer.startConsume = function () {
        if (consumer.session !== null) {
            ...
            consumer.log('Cannot start the queue consumer because not connected to AEM.');
        }
    };

    // Disconnects the consumer from queue on Advanced Event Mesh
    consumer.stopConsume = function () {
        if (consumer.session !== null) {
            ...
            consumer.log('Cannot disconnect the consumer because not connected to Advanced Event Mesh.');
        }
    };

    // Gracefully disconnects from Advanced Event Mesh
    consumer.disconnect = function () {
        consumer.log('Disconnecting from AEM ...');
        if (consumer.session !== null) {
            try {
            ...
            consumer.log('Not connected to Advanced Event Mesh.');
        }
    };
